(function initRestaurantChatbot(){
  ...
  class RestaurantChatbot {
    ...
    cacheNodes(){
      ...
      return {
        ...
        topicBar: root.getElementById('topicBar'),
        topicSelect: root.getElementById('topicSelect'),
        topicText: root.getElementById('topicText'),
        topicMenu: root.getElementById('topicMenu'),
      };
    }
  ...
  function bootstrap(){ new RestaurantChatbot(); }
